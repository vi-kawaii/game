...
function love.load()
    ...
    from3dsmax = g3d.newModel("assets/from3dsmax.obj", "assets/moon.png", nil, nil, {-1,-1,1})
    stairs = g3d.newModel("assets/stairs.obj", "assets/gray.jpg", {0,50,0}, nil, {-1,-1,1})
    ...
    --player:addCollisionModel(from3dsmax)
    player:addCollisionModel(stairs)
